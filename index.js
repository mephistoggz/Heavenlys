...
//KÜFÜR
client.on("messageCreate", async message => {
    const embed = new EmbedBuilder().setTitle('Koruma Sistemi').setTimestamp().setFooter({ text: `Heavenly`, iconURL: client.user.avatarURL() })
...
client.on("messageUpdate", (oldMessage, newMessage) => {
  const embed = new EmbedBuilder().setTitle('Log Sistemi').setTimestamp().setFooter({ text: `Heavenly`, iconURL: client.user.avatarURL() })
